 ...
 * 
 * Portal-based container for toast notifications
 * Positioned at top-right of the screen
 * Displays up to 3 toasts with auto-dismiss and manual dismiss
 */
export function ToastContainer() {
  ...
  const getToastStyles = (type: Toast['type']) => {
    const baseStyles = 'toast p-4 mb-2 min-w-[300px] max-w-md rounded-lg shadow-lg border-l-4 flex items-start justify-between gap-3';
  ...
  return createPortal(
    <div
      className="fixed top-4 right-4 z-[10000] flex flex-col items-end"
      role="region"
